...
const ESTADO_TREE = {
  ...
  ramas: [
    ...
    },
    {
      ...
      razones: [
        { label: 'Baja sin concurso', desc: 'La baja se registra con genera_concurso = false. El cargo no queda vacante — pasa directamente a no_vigente. Caso más común: retención de cargo, reubicación, cargos desfinanciados.' },
      ...
      reglas: [
        ...
        'Solo pasa a no_vigente por baja con genera_concurso = false o por acto administrativo manual.',
        'El padrón semanal NUNCA pone un cargo en no_vigente — solo lo pone en validacion_vacante.',
      ],
    },
    {
      estado: 'VIGENTE',
...
const CICLO_TABS = [
  ...
  },
  {
    ...
    origen: [
      { evento: 'Baja con genera_concurso = false', detalle: 'La baja se registra sin generar concurso. El cargo no queda vacante — pasa directamente a no_vigente. Es el caso más común: retención de cargo, reubicación, cargos desfinanciados.' },
      ...
      { evento: 'Baja manual — Vacante a No Vigente', detalle: 'Un cargo vacante pasa a no vigente de forma manual. La contrapartida es un expediente de alta de otro cargo.' },
    ],
    validaciones: [
      'El padrón semanal NUNCA marca un cargo como no_vigente — solo lo pone en validacion_vacante.',
      'Un cargo no_vigente no puede tener ocupaciones activas (hasta IS NULL).',
  ...
  },
  {
    ...
    validaciones: [
      ...
      'Si se aprueba: se habilita el flujo de alta por baja. El destino final (vigente vacante o no_vigente) lo determina el campo genera_concurso del acto administrativo.',
      'Si se rechaza: cargo.estado vuelve a vigente sin modificar la ocupación.',
      'Es el origen normal del flujo de alta por baja en el sistema operativo.',
