...
import { codigosRegistroRoutes } from './modules/codigos-registro/codigos-registro.routes.js'
...
await app.register(codigosRegistroRoutes, { prefix: '/api/v1/codigos-registro' })
